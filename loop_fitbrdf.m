...
for i = 1:iter
    ...
    imname = strcat('/scratch/gk925/hpc_brdf_fitting20/fit_results/multispectral/', fitname1);
    ...
    imname = strcat('/scratch/gk925/hpc_brdf_fitting20/fit_results/multispectral/', fitname2);
