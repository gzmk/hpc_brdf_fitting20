...
writetable(T,'/scratch/gk925/hpc_brdf_fitting20/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/hpc_brdf_fitting20');
...
imPath = ['/scratch/gk925/hpc_brdf_fitting20/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
